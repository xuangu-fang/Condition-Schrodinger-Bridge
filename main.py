    ...
    def sb_joint_train(self, opt):
        ...
        for it in range(opt.num_itr):
            ...
            if (it + 1) % opt.eval_itr == 0:
                ...
                util.save_toy_npy_traj(opt, 'train_{}_lr_sigma_{}_node_{}_block_{}_it{}_seed_{}'.format(opt.problem_name, opt.lr, opt.sigma_max, opt.hidden_nodes, opt.blocks, it+1, opt.seed), xs_b.detach().cpu().numpy())
